<template>
  <div>
    ...
    <Button-group>
      <Button @click="changeType(1)" :class="{ active: formValidate.type === 4 }">中外名著</Button>
      <Button @click="changeType(2)" :class="{ active: formValidate.type === 5 }">传统文学</Button>
      <Button @click="changeType(3)" :class="{ active: formValidate.type === 6 }">历史传记</Button>
    </Button-group>
    <!--
